	...
	<script type="text/javascript">
		...
		function del() {
			...
			if(window.confirm("确定删除该菜单")){
				window.location.href= "delModule?id="+id;
			}
		}
      ...
      <div class="container">
		<div class="row">
			  ...
			  <div class="col-md-8">
			  		...
			  		<!-- 添加子模块form -->
			  		<form id="addForm" class="form-horizontal" action="addModule" role="form" method="post">
					...
					<!-- 修改form -->
					<form id="updateForm" class="form-horizontal" action="updateModule" role="form" method="post">
						  <div class="form-group">
						    <label for="inputPassword3" class="col-sm-2 control-label">菜单名称:</label>
						    <div class="col-sm-6">
