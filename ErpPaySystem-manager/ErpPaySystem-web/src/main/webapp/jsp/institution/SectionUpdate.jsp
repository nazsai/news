   ...
   <script type="text/javascript">
      $(function(){
      		$(".jqtransform").Validform({
      			tiptype:3,
      			datatype:{
      				"companyname":function(gets,obj,curform,regxp){
      					//参数gets是获取到的表单元素值，obj为当前表单元素，curform为当前验证的表单，regxp为内置的一些正则表达式的引用;
      					var oldName = '${vo.companyname}';
      					var result = true;
     ...
     <div id="forms" class="mt10">
        <div class="box">
          <div class="box_border">
            <div class="box_top"><b class="pl15">修改机构</b></div>
            <div class="box_center">
              <form action="<%=request.getContextPath() %>/updateSectionVo"  method="post" class="jqtransform">
              	<input type="hidden" name="sectionid" value="${vo.sectionid}">
               <table class="form_table pt15 pb15" width="100%" border="0" cellpadding="0" cellspacing="0">
                 <tr>
                  <td class="td_right">机构名称：</td>
                  <td class=""> 
                    <input type="text" name="companyname" value="${vo.companyname}" datatype="*1-50,companyname"  class="input-text lh30" size="40">
                  </td>
                </tr>
                 <tr>
