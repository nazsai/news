...
<script type="text/html" id="barDemo">
  ...
  <a class="layui-btn layui-btn-xs" lay-event="power">设置权限</a>
...
<body>
	...
	<ul class="layui-nav" lay-filter="">
  	...
  	<li class="layui-nav-item layui-this"><a href="${ctx}/jsp/institution/shopList.jsp">门店管理</a></li>
  	<li class="layui-nav-item"><a href="${ctx}/jsp/institution/shopmoudleList.jsp">权限模版</a></li>
	<div class="container">

		<div id="search_bar" class="mt10">
			<form id="pageForm" action="institution/shopList" method="post">
							...
							<table class="form_table" border="0" cellpadding="0"
								...
								<tr>
									...
									<td><input type="text" name="shopname"
										value="${shop.shopname }" class="input-text lh25"
										size="30"></td>
									<td>
								...
								<tr>
									<td>所属品牌：</td>
									<td>
										<input type="checkbox" name="" title="安少爷米线">
									</td>
								</tr>
								<tr>
									<td>所属区域：</td>
  ...
  //…
	...
	layui.use('table', function() {
		...
		tableIns = table.render({
			...
			skin : 'row', //行边框风格
			even : true, //开启隔行背景
			url : '${ctx}/institution/shopList', //数据接口
			page : true, //开启分页
			request : {
