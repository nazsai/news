...
<script type="text/javascript" src="<%=request.getContextPath() %>/resource/layui/layui.js"></script>	
   ...
   <script type="text/javascript">
      ...
      function deleteBranch(id) {
      	...
      	if(flag) {
      		window.location.href="deleteBranchInfo?branchId="+id;
      	}
      }
 ...
 <body>
  <div class="container">
    ...
    <div id="search_bar" class="mt10">
   		 <form id="pageForm" action="pageFindBranchInfo" method="post">
	          ...
	          <div class="box_border">
	            ...
	            <div class="box_center pt10 pb10">
	              <table class="form_table" border="0" cellpadding="0" cellspacing="0">
	                <tr>
	                  <td>机构名称</td>
	                  <td><input type="text" name="branchName" value="${branchInfo.branchName }" class="input-text lh25" size="30"></td>
					<td>
					<input type="submit" name="button" class="btn btn82 btn_search" value="查询">  
					<input type="button" name="button" onclick="window.location.href='toAddBranchInfoPage'" class="btn btn82 btn_add" value="新增"> 
					</td>
					</tr>
	              </table>
	            </div>
              ...
              <table width="100%" border="0" cellpadding="0" cellspacing="0" class="list_table" style="text-align: center;">
                ...
                <c:forEach items="${page.list }" var="branch">
	                <tr class="tr">
	                   ...
	                   <td>
                   		 <input type="button" onclick="window.location.href='toUpdateBranchInfoPage/${branch.branchId }'" value="修改" class="ext_btn ext_btn_submit">
               			 <input type="button" onclick="deleteBranch(${branch.branchId })" class="ext_btn ext_btn_error" value="删除">
	                   </td>
	                 </tr>
                </c:forEach>
              </table>
